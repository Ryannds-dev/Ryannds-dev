...
Étudiant en développement web. Je construis des applications complètes : front-end React, API REST Node.js, bases de données MongoDB avec un focus sur la lisibilité du code et l'expérience utilisateur.
...
[![Backend](https://skillicons.dev/icons?i=nodejs,mongodb&theme=dark)](https://skillicons.dev)
